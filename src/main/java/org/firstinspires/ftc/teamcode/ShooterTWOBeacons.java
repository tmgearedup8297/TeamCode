...
public abstract class ShooterTWOBeacons extends AutonomousVelVort {
    ...
    public void activateShooterBeacon(String colorString) throws InterruptedException {
        ...
        sleep(200);
        moveStraight(0.30, 42, true); //drive the majority of the distance between beacons before finding the line
        sleep(200);
        ...
        if(colorString.equalsIgnoreCase("blue")) {
            ...
            if ((BLUEfrontColor.red() > BLUEfrontColor.blue()) || (BLUEbackColor.blue() > BLUEbackColor.red())) {
                ...
                moveStraight(0.15, 3, true); //move forward so so pusher is aligned
