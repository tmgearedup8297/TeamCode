...
public class CVJewelVuforiaTestRed extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        straightForward(1.9,1.9,1.9,1.9);
        brake();
        sleep(250);
        shoulderleft.setPosition(LEFT_SHOULDER_OUT);
        shoulderleft = hardwareMap.servo.get("shoulderRight");
        ...
        while(!leftLim.getState()&&(runtime.seconds()<start+1.1)){
        ...
        sleep(250);
        if(pos==2)
            moveDistForward(.9, .9, .9, .9);
        else if(pos==1)
            moveDistForward(6,6,6,6);
        else
            moveDistForward(13,13,13,13);
        brake();
        ...
        brake();
        sleep(1000);
        strafeDistRight(3.75,3.75,3.75,3.75);
        brake();
        sleep(250);
