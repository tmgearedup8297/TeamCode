...
@Autonomous(name="Blue1WorldsColorSensor", group="Linear Opmode")
//@Disabled
public class WORLDSBlue1ColorSensor extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while(!rightLim.getState()&&(runtime.seconds()<start+1.5)){
